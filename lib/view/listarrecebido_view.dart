...
class ListarRecebidoView extends StatefulWidget {
  const ListarRecebidoView({super.key});

  @override
  State<ListarRecebidoView> createState() => _ListarRecebidoViewState();
}
class _ListarRecebidoViewState extends State<ListarRecebidoView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Color.fromARGB(250, 26, 35, 126),
        title: Row(
          children: [
            Expanded(child: Text('Recebidos: Todos os usuários')),
      ...
      body: Padding(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: ListarController().listarRecebido().snapshots(),
          builder: (context, snapshot) {
